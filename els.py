...
#静态界面（背景、色块等）
interface = pygame.image.load(r'interface.jpg').convert()
gameover = pygame.image.load(r'GAME_OVER.jpg').convert()
...
#下一个方块预览图        
surface_z_left = pygame.image.load(r'surface_z_left.png').convert_alpha()
surface_z_right = pygame.image.load(r'surface_z_right.png').convert_alpha()
surface_long = pygame.image.load(r'surface_long.png').convert_alpha()
surface_cross = pygame.image.load(r'surface_cross.png').convert_alpha()
surface_rect = pygame.image.load(r'surface_rect.png').convert_alpha()
surface_l_left = pygame.image.load(r'surface_l_left.png').convert_alpha()
surface_l_right = pygame.image.load(r'surface_l_right.png').convert_alpha()
